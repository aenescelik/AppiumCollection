...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("PlatformName", ConfigReader.getProperty("platformName")); // android
        extentReports.setSystemInfo("Automation Engineer", "Enes");
        extentHtmlReporter.config().setDocumentTitle("Invio Maps Test");
        extentHtmlReporter.config().setReportName("Invio Maps Automation Reports");
    }
