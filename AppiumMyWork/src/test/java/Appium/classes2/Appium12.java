...
public class Appium12 extends ApiDemosBase {
...
//        List<MobileElement> list = driver.findElementsByAndroidUIAutomator
//        ("UiSelector().resourceId(\"android:id/checkbox\").checked(false)");
...
//        System.out.println("secili");
        ...
        List<MobileElement> list = driver.findElementsByAndroidUIAutomator
                ("UiSelector().resourceId(\"android:id/checkbox\").checked(false)");
        List<MobileElement> list1 = driver.findElementsByAndroidUIAutomator
                ("UiSelector().resourceId(\"android:id/checkbox\").checked(true)");
        System.out.println(list.size());
