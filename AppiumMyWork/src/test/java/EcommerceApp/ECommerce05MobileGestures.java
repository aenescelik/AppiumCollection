...
public class ECommerce05MobileGestures {
     ...
     public void test() throws MalformedURLException, InterruptedException {
         ...
         desiredCapabilities.setCapability(MobileCapabilityType.APP,
                 "C:\\Users\\enesc\\AppiumProjects\\AppiumMyWork\\src\\apps\\General-Store.apk");
...
//4 2 secilecek elementi scroll yaparak bulduk
         ...
         //burada resourceId'yi ekliyoruz scroll ettiğimizde tam görünsün diye.
       ...
       //mobile gesture kullanacagiz bunun icin TouchAction class kullaniyoruz
         ...
         touchAction
                 .longPress
                         (LongPressOptions.
                                 longPressOptions().
                                 withElement(ElementOption.element(termsOfCondButton)))
                 .release().perform();
         //popup onaylama
